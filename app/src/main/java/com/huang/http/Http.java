...
import com.huang.utils.SpUtils;
import com.huang.utils.UrlHelper;
    ...
    private static Interceptor addCacheInterceptor() {
        Interceptor cacheInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (!NetworkUtil.isNetworkAvailable(HuangApplication.getAppContext())) {
        ...
        if (retrofit == null) {
            synchronized (Http.class) {
                if (retrofit == null) {
                    ...
                    //设置 请求的缓存的大小跟位置
                    File cacheFile = new File(HuangApplication.getAppContext().getCacheDir(), "cache");
